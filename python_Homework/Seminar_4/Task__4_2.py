...
if begin_Bushes == len(list1):
    count_Berry = list1[0] + list1[-1] + list1[-2]
elif len(list1) >= begin_Bushes > 0:
    count_Berry = list1[begin_Bushes - 1] + list1[begin_Bushes - 2] + list1[begin_Bushes]
else:
    print(f"{begin_Bushes}-го куста нету!")

print(f"Макс. кол-во ягод {count_Berry}, собрано для куста {begin_Bushes}")
